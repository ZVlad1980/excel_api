create sequence dv_sr_benefits_seq cache 10000 order
/
create table dv_sr_lspv_det_t( --детализация движения средств
  id                 int 
    default dv_sr_benefits_seq.nextval
    constraint dv_sr_benefits_pk primary key,
  ...
  constraint dv_sr_lspv_det_prc_fk foreign key (process_id)
